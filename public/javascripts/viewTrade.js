...
$(document).ready(function(){
	$('.viewTrade-comment-count').html('<span id="viewTrade-comment-count-num">1000</span> characters remaining');
	$('.viewTrade-postComment textarea').textlimit('#viewTrade-comment-count-num',1000);	
});
